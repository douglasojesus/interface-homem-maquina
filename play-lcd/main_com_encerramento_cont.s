...
_start:
    ...
    sensoriamento_continuo:

        @ implementar aqui a parte de continuidade de temperatura ou umidade 
        
        GPIOPinEstado b2
        CMP R1, #0 
        BEQ cancelar_sensoriamento_continuo

        B sensoriamento_continuo
        
    cancelar_sensoriamento_continuo:

        CMP R13, #3
        BEQ cancelar_sensoriamento_continuo_temp

        CMP R13, #4
        BEQ cancelar_sensoriamento_continuo_umid
        
    cancelar_sensoriamento_continuo_temp:

        @Desativa temperatura
        MOV R13, #5
        UART_TX R13 @ contador que tem o comando a ser executado
        UART_TX R12 @ contador que tem o endereço do sensor
    ...
    cancelar_sensoriamento_continuo_umid:
